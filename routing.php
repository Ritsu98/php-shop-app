...
Utils::addRoute('ordersList', 'OrderListCtrl',['worker','admin']);
Utils::addRoute('statusUpdate', 'OrderListCtrl',['worker']);
Utils::addRoute('orderView', 'OrderListCtrl',['worker','admin','user']);
...
Utils::addRoute('userOrdersList', 'UserOrderCtrl',['admin','worker','user']);
